...
from app.forms import LoginForm, RegisterationForm, EditProfileForm, PostForm, ResetPasswordRequest, ResetPasswordForm
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            return redirect(url_for('reset_password_request', title='Reset Password', form=form))
